...
<html>
<head>
	<title>Burguer Shop | Producto</title>
	<meta charset="utf-8">
...
<body>
	...
	<div class="main-content">
		<div class="content-page">
			<section>
				<div class="part1">
					<img id="idimg" src="assets/Images/Productos/crepe.jpg">
				</div>
				<div class="part2">
	...
	<script type="text/javascript">
		$(document).ready(function(){
			$.ajax({
				url:'Services/producto/get_all_products.php',
				type:'POST',
				data:{},
				success:function(data){
					...
					for (var i = 0; i < data.datos.length; i++) {
						if (data.datos[i].codpro==p) {
							document.getElementById("idimg").src="Assets/Images/productos/"+data.datos[i].rutimapro;
		...
		function iniciar_compra(){
			$.ajax({
				url:'Services/compra/validar_inicio_compra.php',
				type:'POST',
				data:{
					codpro:p
				},
